    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">NIFTY</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {renderPriceTicker('NIFTY')}
            {renderIndicators('NIFTY')}
          </div>
        </section>

        {/* BANKNIFTY Section */}
        <section>
          <h2 className="text-xl font-semibold text-gray-800 mb-4">BANKNIFTY</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {renderPriceTicker('BANKNIFTY')}
            {renderIndicators('BANKNIFTY')}
          </div>
        </section>

        {/* Info Footer */}
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>Data updates every 3 minutes • Live prices via Socket.io</p>
          <p className="mt-1">Phase 1: Market Data + Indicators (EMA, VWAP)</p>
        </div>
      </main>
    </div>
  );
